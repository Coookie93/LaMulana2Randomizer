...
namespace LM2RandomiserMod
{
    public class DevUI : MonoBehaviour
    {
        ...
        void OnGUI() {
            ...
            {
                sys.setPandaModeHP(GUI.Toggle(new Rect(200, 0, 120, 25), sys.getPandaModeHP(), "Panda Mode"));
                sys.setPandaModeHit(GUI.Toggle(new Rect(200, 25, 120, 25), sys.getPandaModeHit(), "Panda Hit Mode"));
