...
namespace LM2RandomiserMod
{
    public abstract class ExitDB
    {
        ...
        private static readonly Dictionary<ExitID, ExitInfo> connectionData = new Dictionary<ExitID, ExitInfo>(){
            ...
            //gates
            { ExitID.f00GateY0,       new ExitInfo("PlayerStart f00GateY0",       0,  0,  0)},
            ...
            { ExitID.f02GateYA,       new ExitInfo("PlayerStart f02GateYA",       2,  0,  0)},
            { ExitID.f03GateYC,       new ExitInfo("PlayerStart f03GateYC",       3,  0,  0)},
            { ExitID.f04GateYB,       new ExitInfo("PlayerStart f04GateYB",       4,  0,  0)},
            { ExitID.f05GateP1,       new ExitInfo("PlayerStart f05GateP1",       5,  9,  4)},
            { ExitID.f06GateP0,       new ExitInfo("PlayerStart f06GateP0",       6,  0,  0)},
            ...
            { ExitID.f11GateP0,       new ExitInfo("PlayerStart f11GateP0",      11,  0,  0)},
            { ExitID.f12GateP0,       new ExitInfo("PlayerStart f12GateP0",      12,  0,  0)},
            { ExitID.f13GateP0,       new ExitInfo("PlayerStart f13GateP0",      13,  0,  0)},
            { ExitID.fLGate,          new ExitInfo("PlayerStart fLGate",         17,  0,  0)},
            { ExitID.fL11GateY0,      new ExitInfo("PlayerStart fL11GateY0",     22,  5, 17)},
            { ExitID.fL11GateN,       new ExitInfo("PlayerStart fL11GateN",      22,  0,  0)},
