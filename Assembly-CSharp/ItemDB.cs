...
namespace LM2RandomiserMod
{
    public abstract class ItemDB
    {
        ...
        private static readonly Dictionary<ItemID, ItemInfo> itemData = new Dictionary<ItemID, ItemInfo>
        {
            ...
            {ItemID.Gauntlet,                   new ItemInfo("Gauntlet",         "Gauntlet",          "item",        29,      60,    1)},
            ...
            {ItemID.Spaulder,                   new ItemInfo("Spaulder",         "Spaulder",          "item",        34,      60,    1)},
            ...
            {ItemID.Whip,                       new ItemInfo("Whip",             "Whip",              "weapon",      62,      40,    1)},
            ...
            {ItemID.FutureDevelopmentCompany,   new ItemInfo("Future DC",        "Future DC",         "soft",        98,      30,    1)},
